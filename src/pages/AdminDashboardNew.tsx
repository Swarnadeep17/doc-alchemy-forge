...
import AnalyticsTabNew from "../components/admin/AnalyticsTabNew";
...
const AdminDashboardNew = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<typeof TABS[number]["key"]>("analytics");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex flex-col items-center justify-center px-2 py-8 w-full">
      <div className="w-full max-w-7xl mx-auto bg-gray-900/95 border border-cyan-400/30 shadow-lg rounded-xl p-10 animate-fade-in">
        ...
        {/* Tab Content */}
        <div className="mt-4">
          {selectedTab === "analytics" && <AnalyticsTabNew />}
